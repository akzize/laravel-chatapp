...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div class="sidebar-card d-none d-lg-flex">
                    ...
                    <p class="mb-2 text-center"><strong>SB Admin Pro</strong> is packed with premium features,
        ...
        <script src="build/assets/app-721b7043.js"></script>
        <script>
            // to get the logged in user
            let loggedInUser = {{ auth()->id() }}
        </script>
        @yield('scripts')
    </body>
